                    ...
                    <div class="card border-0 shadow">
                        <div class="card-body">
                            ...
                            <form action="" method="post" >
                              ...
                              <input type="passward" name="passward" id="passward" class="form-control my-4 py-2"
                                  placeholder="Password" />



                                <div class="text-center mt-3">
                                  <input type="submit" value="Login" name="submit" class="btn btn-primary px-3"/>
                                  <p class="link"><a href="register1.php">Don't have an account ?</a></p>
                                </div>
